...
namespace PushAPIToSQL
{
    ...
    {  
        ...
        public string FunctionHandler(string input, ILambdaContext context)
        {
            ...
            string sqladdress = "server=stat-controler-instance-1.cdzwulcek08o.eu-west-2.rds.amazonaws.com;user id=admin;persistsecurityinfo=True;database=StatControlSql;Password=HowManyDucks2";
            ...
            for (int z = 0; z < steamIDDir.Count; z++)
            {
                using (var client = new WebClient())
                {
                    ...
                    {
                        errorlist += $"The SteamID:{steamIDDir[z].ToString()} Failed To Retreave Data From The API, ";
                    }
                }
            }
            //SQL
